        ...
        <table class="data-table" id="booksTable">
            ...
            <tbody id="booksTableBody">
                ...
                <tr data-id="<?= $book['id'] ?>">
                    ...
                    <td>
                        <img class="thumb"
                             src="<?= !empty($book['cover_image'])
                                    ? UPLOAD_COVER_URL . e($book['cover_image'])
                                    : DEFAULT_COVER ?>"
                             alt="<?= e($book['title']) ?>">
                    </td>
                    ...
                    <td>
                        <a class="table-title-link"
                           href="<?= BASE_URL ?>/views/book_details.php?id=<?= $book['id'] ?>">
                            <?= e($book['title']) ?>
                        </a>
                    ...
                    <td class="actions-cell">
                        ...
                        <a href="<?= BASE_URL ?>/views/book_details.php?id=<?= $book['id'] ?>"
                           class="icon-btn sm"
                           title="View">
                        ...
                        <button class="icon-btn sm btn-edit-book"
                                data-id="<?= $book['id'] ?>"
                                title="Edit">
                            <i class="fa-regular fa-pen-to-square"></i>
                        </button>

                        <button class="icon-btn sm danger btn-delete-book"
                                data-id="<?= $book['id'] ?>"
...
<div class="modal-backdrop" id="bookModalBackdrop">
    <div class="modal">
        <div class="modal-header">
            ...
            <button class="icon-btn" id="closeBookModal">
